...
def withdraw(
    ...
    try:
        ...
        user_balance = token_balance_tracker_contract.functions.mapRequesterBalances(
            sender
        ).call()
...
def main() -> None:
    """Runs the withdraw functionality for the token mech type"""
    print_title("Token Withdraw")
    print("This script will assist you in withdrawing token balance for mech requests.")
    print()
    ...
    withdraw_tx = withdraw(ledger_api, crypto, token_balance_tracker_contract)
    if not withdraw_tx:
