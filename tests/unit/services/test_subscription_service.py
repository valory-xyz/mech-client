...
class TestSubscriptionService:
    ...
    def test_check_subscription_status(
        ...
        # Execute
        result = service.check_subscription_status(requester_address)

        # Verify NFT contract created and balance checked
        mock_contract_factory.create.assert_called_once()
        mock_nft_contract.get_balance.assert_called_once_with(requester_address, "1")

        # Verify result
        assert result["address"] == requester_address
