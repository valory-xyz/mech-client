...
All commands require `--chain-config` with one of these five chain names. Arbitrum and Celo exist in the configuration but have no marketplace support and are currently non-functional.
